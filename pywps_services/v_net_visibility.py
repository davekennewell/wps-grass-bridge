...
class v_net_visibility(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'v.net.visibility', title = 'Visibility graph construction.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'vector'}, {'type': 'simple', 'title': 'network'}, {'type': 'simple', 'title': 'path'}, {'type': 'simple', 'title': 'visibility'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/v.net.visibility.html')
