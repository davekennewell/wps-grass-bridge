...
class r_distance(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addComplexInput(identifier = 'maps', title = 'Maps for computing inter-class distances', minOccurs = 2, maxOccurs = 2, formats = [{'mimeType': 'image/tiff'}, {'mimeType': 'image/geotiff'}, {'mimeType': 'application/geotiff'}, {'mimeType': 'application/x-geotiff'}, {'mimeType': 'image/png'}, {'mimeType': 'image/gif'}, {'mimeType': 'image/jpeg'}, {'mimeType': 'application/x-erdas-hfa'}, {'mimeType': 'application/netcdf'}, {'mimeType': 'application/x-netcdf'}])
    self.addLiteralInput(identifier = 'fs', title = 'Output field separator', minOccurs = 0, maxOccurs = 1, type = type("string"), default = ":")
