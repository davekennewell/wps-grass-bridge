...
class v_net_connectivity(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'set1_layer', title = 'A single vector map can be connected to multiple database tables. This number determines which table to use. Layer name for OGR access.', minOccurs = 1, maxOccurs = 1, type = type("string"), default = "1")
