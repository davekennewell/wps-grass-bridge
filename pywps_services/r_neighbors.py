...
class r_neighbors(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'method', title = 'Neighborhood operation', minOccurs = 0, maxOccurs = 1024, type = type("string"), default = "average", allowedValues = ['average', 'median', 'mode', 'minimum', 'maximum', 'range', 'stddev', 'sum', 'count', 'variance', 'diversity', 'interspersion', 'quart1', 'quart3', 'perc90', 'quantile'])
    ...
    self.addLiteralInput(identifier = 'quantile', title = 'Quantile to calculate for method=quantile', minOccurs = 0, maxOccurs = 1024, type = type(0.0), default = 0.5)
