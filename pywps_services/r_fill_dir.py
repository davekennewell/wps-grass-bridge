...
class r_fill_dir(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'type', title = 'Aspect direction format', minOccurs = 0, maxOccurs = 1, type = type("string"), default = "grass", allowedValues = ['agnps', 'answers', 'grass'])
