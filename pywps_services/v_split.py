...
class v_split(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'units', title = 'Length units', minOccurs = 0, maxOccurs = 1, type = type("string"), default = "meters", allowedValues = ['meters', 'kilometers', 'feet', 'miles', 'nautmiles'])
