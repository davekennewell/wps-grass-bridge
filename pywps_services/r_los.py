...
class r_los(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'r.los', title = 'Line-of-sight raster analysis program.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'raster'}, {'type': 'simple', 'title': 'viewshed'}, {'type': 'simple', 'title': 'line of sight'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/r.los.html')
