...
class r_univar(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'separator', title = 'Special characters: newline, space, comma, tab', minOccurs = 0, maxOccurs = 1, type = type("string"), default = "|")
