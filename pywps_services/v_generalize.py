...
class v_generalize(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'method', title = 'Generalization algorithm', minOccurs = 1, maxOccurs = 1, type = type("string"), default = "douglas", allowedValues = ['douglas', 'douglas_reduction', 'lang', 'reduction', 'reumann', 'boyle', 'sliding_averaging', 'distance_weighting', 'chaiken', 'hermite', 'snakes', 'network', 'displacement'])
