...
class v_sample(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'v.sample', title = 'Samples a raster map at vector point locations.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'vector'}, {'type': 'simple', 'title': 'sampling'}, {'type': 'simple', 'title': 'raster'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/v.sample.html')
