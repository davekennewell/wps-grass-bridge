...
class t_rast_extract(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'base', title = 'The base name of the new created raster maps. This name will be extended with a numerical prefix', minOccurs = 0, maxOccurs = 1, type = type("string"), allowedValues = '*')
