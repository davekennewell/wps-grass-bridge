...
class t_topology(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 't.topology', title = 'Lists temporal topology of a space time dataset.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'temporal'}, {'type': 'simple', 'title': 'topology'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/t.topology.html')
