...
class v_voronoi(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'v.voronoi', title = 'Creates a Voronoi diagram from an input vector map containing points or centroids.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'vector'}, {'type': 'simple', 'title': 'geometry'}, {'type': 'simple', 'title': 'triangulation'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/v.voronoi.html')
