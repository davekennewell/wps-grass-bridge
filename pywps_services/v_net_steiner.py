...
class v_net_steiner(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'v.net.steiner', title = 'Note that Minimum Steiner Tree problem is NP-hard and heuristic algorithm is used in this module so the result may be sub optimal', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'vector'}, {'type': 'simple', 'title': 'networking'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/v.net.steiner.html')
