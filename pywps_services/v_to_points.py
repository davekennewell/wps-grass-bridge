...
class v_to_points(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'llayer', title = 'Vector features can have category values in different layers. This number determines which layer to use. When used with direct OGR access this is the layer name.', minOccurs = 1, maxOccurs = 1, type = type("string"), default = "1")
