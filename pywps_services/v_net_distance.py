...
class v_net_distance(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'to_layer', title = 'To layer number or name', minOccurs = 1, maxOccurs = 1, type = type("string"), default = "1")
    ...
    self.addLiteralInput(identifier = 'afcolumn', title = 'Arc forward/both direction(s) cost column', minOccurs = 1, maxOccurs = 1, type = type("string"), allowedValues = '*')
