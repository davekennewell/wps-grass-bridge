...
class v_krige(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'model', title = 'Leave empty to test all models (requires automap)', minOccurs = 0, maxOccurs = 1024, type = type("string"), allowedValues = ['Nug', 'Exp', 'Sph', 'Gau', 'Exc', 'Mat', 'Ste', 'Cir', 'Lin', 'Bes', 'Pen', 'Per', 'Hol', 'Log', 'Pow', 'Spl', 'Leg', 'Err', 'Int'])
    ...
    self.addComplexOutput(identifier = 'output_var', title = 'If omitted, will be &#60;input name&#62;_kriging.var', formats = [{'mimeType': 'image/tiff'}, {'mimeType': 'image/geotiff'}, {'mimeType': 'application/geotiff'}, {'mimeType': 'application/x-geotiff'}, {'mimeType': 'application/x-erdas-hfa'}, {'mimeType': 'application/netcdf'}, {'mimeType': 'application/x-netcdf'}])
