...
class v_net_alloc(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'ccats', title = 'Category values', abstract = 'Categories of centers (points on nodes) to which net will be allocated, layer for this categories is given by nlayer option', minOccurs = 1, maxOccurs = 1, type = type("string"), allowedValues = '*')
