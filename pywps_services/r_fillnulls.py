...
class r_fillnulls(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'method', title = 'Interpolation method', minOccurs = 1, maxOccurs = 1, type = type("string"), default = "rst", allowedValues = ['bilinear', 'bicubic', 'rst'])
