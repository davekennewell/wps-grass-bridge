...
class r_horizon(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'coord', title = 'Coordinate for which you want to calculate the horizon', minOccurs = 0, maxOccurs = 2, type = type(0.0), allowedValues = '*')
