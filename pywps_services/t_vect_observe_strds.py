...
class t_vect_observe_strds(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'column', title = 'Name of the vector column to be created and to store sampled raster values, otherwise the space time raster name is used as column name', minOccurs = 0, maxOccurs = 1, type = type("string"), allowedValues = '*')
    ...
    self.addComplexOutput(identifier = 'vector_output', title = 'Name of the new created vector map that stores the sampled values', formats = [{'mimeType': 'text/xml', 'schema': 'http://schemas.opengis.net/gml/3.1.1/base/gml.xsd', 'encoding': 'UTF-8'}, {'mimeType': 'application/xml', 'schema': 'http://schemas.opengis.net/gml/3.1.1/base/gml.xsd', 'encoding': 'UTF-8'}, {'mimeType': 'text/xml', 'schema': 'http://schemas.opengis.net/gml/2.1.2/feature.xsd', 'encoding': 'UTF-8'}, {'mimeType': 'application/xml', 'schema': 'http://schemas.opengis.net/gml/2.1.2/feature.xsd', 'encoding': 'UTF-8'}, {'mimeType': 'text/xml', 'schema': 'http://schemas.opengis.net/kml/2.2.0/ogckml22.xsd', 'encoding': 'UTF-8'}])
