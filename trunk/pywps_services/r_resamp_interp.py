...
class r_resamp_interp(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'method', title = 'Interpolation method', minOccurs = 0, maxOccurs = 1, type = type("string"), default = "bilinear", allowedValues = ['nearest', 'bilinear', 'bicubic', 'lanczos'])
