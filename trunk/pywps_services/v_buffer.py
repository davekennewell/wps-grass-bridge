...
class v_buffer(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'v.buffer', title = 'Creates a buffer around vector features of given type.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'vector'}, {'type': 'simple', 'title': 'geometry'}, {'type': 'simple', 'title': 'buffer'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/v.buffer.html')
