...
class r_bitpattern(WPSProcess):
  ...
  def __init__(self):
    WPSProcess.__init__(self, identifier = 'r.bitpattern', title = 'Compares bit patterns with a raster map.', version = 1, statusSupported = True, storeSupported = True, metadata = [{'type': 'simple', 'title': 'raster'}], abstract = 'http://grass.osgeo.org/grass70/manuals/html70_user/r.bitpattern.html')
