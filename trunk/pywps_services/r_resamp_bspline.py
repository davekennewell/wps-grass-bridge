...
class r_resamp_bspline(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addComplexOutput(identifier = 'grid', title = 'Output vector with interpolation grid', formats = [{'mimeType': 'text/xml', 'schema': 'http://schemas.opengis.net/gml/2.1.2/feature.xsd', 'encoding': 'UTF-8'}, {'mimeType': 'text/xml', 'schema': 'http://schemas.opengis.net/kml/2.2.0/ogckml22.xsd', 'encoding': 'UTF-8'}])
