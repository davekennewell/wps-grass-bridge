...
class r_walk(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'walk_coeff', title = 'Coefficients for walking energy formula parameters a,b,c,d', minOccurs = 0, maxOccurs = 1, type = type(0.0), default = 0.72,6.0,1.9998,-1.9998)
