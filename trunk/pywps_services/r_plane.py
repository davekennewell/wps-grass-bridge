...
class r_plane(WPSProcess):
  ...
  def __init__(self):
    ...
    self.addLiteralInput(identifier = 'type', title = 'Type of the raster map to be created', minOccurs = 1, maxOccurs = 1, type = type("string"), allowedValues = ['int', 'float', 'double'])
