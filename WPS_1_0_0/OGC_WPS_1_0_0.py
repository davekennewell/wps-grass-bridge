# ./WPS_1_0_0/OGC_WPS_1_0_0.py
# PyXB bindings for NamespaceModule
# NSM:76ad5258aae86a5ac0f3bea350c0ef82976f8647
# Generated 2010-04-24 12:16:11.758598 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
class STD_ANON_1 (pyxb.binding.datatypes.integer):

    """An atomic simple type."""

    _ExpandedName = None
    _Documentation = None
STD_ANON_1._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=STD_ANON_1, value=pyxb.binding.datatypes.integer(99L))
STD_ANON_1._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON_1, value=pyxb.binding.datatypes.integer(0L))
STD_ANON_1._InitializeFacetMap(STD_ANON_1._CF_maxInclusive,
   STD_ANON_1._CF_minInclusive)
...
STD_ANON_2.GET = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'GET')
STD_ANON_2.POST = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'POST')
...
class ResponseBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_opengis_netwps1_0_0_ResponseBaseType_version', WPS_1_0_0._ows.VersionType, fixed=True, unicode_default=u'1.0.0', required=True)
...
class CTD_ANON_1 (ResponseBaseType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    __ProcessDescription = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'ProcessDescription'), 'ProcessDescription', '__httpwww_opengis_netwps1_0_0_CTD_ANON_1_ProcessDescription', True)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __UOM = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'UOM'), 'UOM', '__httpwww_opengis_netwps1_0_0_CTD_ANON_2_httpwww_opengis_netows1_1UOM', False)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netwps1_0_0_CTD_ANON_3_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI, required=True)
...
class OutputDefinitionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mimeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mimeType'), 'mimeType', '__httpwww_opengis_netwps1_0_0_OutputDefinitionType_mimeType', WPS_1_0_0._ows.MimeType)
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Output = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'Output'), 'Output', '__httpwww_opengis_netwps1_0_0_CTD_ANON_4_Output', True)
...
class OutputReferenceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute mimeType uses Python identifier mimeType
    __mimeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mimeType'), 'mimeType', '__httpwww_opengis_netwps1_0_0_OutputReferenceType_mimeType', WPS_1_0_0._ows.MimeType)
...
class ProcessStartedType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __percentCompleted = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'percentCompleted'), 'percentCompleted', '__httpwww_opengis_netwps1_0_0_ProcessStartedType_percentCompleted', STD_ANON_1)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element CRS uses Python identifier CRS
    __CRS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'CRS'), 'CRS', '__httpwww_opengis_netwps1_0_0_CTD_ANON_5_CRS', False)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Process = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Process'), 'Process', '__httpwww_opengis_netwps1_0_0_CTD_ANON_6_httpwww_opengis_netwps1_0_0Process', True)
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}href uses Python identifier href
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netwps1_0_0_CTD_ANON_7_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI, required=True)
...
class ComplexDataType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute mimeType uses Python identifier mimeType
    __mimeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mimeType'), 'mimeType', '__httpwww_opengis_netwps1_0_0_ComplexDataType_mimeType', WPS_1_0_0._ows.MimeType)
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Language = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Language'), 'Language', '__httpwww_opengis_netwps1_0_0_CTD_ANON_8_httpwww_opengis_netows1_1Language', False)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __key = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'key'), 'key', '__httpwww_opengis_netwps1_0_0_CTD_ANON_9_key', pyxb.binding.datatypes.string, required=True)
    
    key = property(__key.value, __key.set, None, u'Key portion of the Key-Value pair in the HTTP request header.')

    
    # Attribute value uses Python identifier value_
    __value = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'value'), 'value_', '__httpwww_opengis_netwps1_0_0_CTD_ANON_9_value', pyxb.binding.datatypes.string, required=True)
...
class CTD_ANON_10 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Input = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'Input'), 'Input', '__httpwww_opengis_netwps1_0_0_CTD_ANON_10_Input', True)
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Default = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Default'), 'Default', '__httpwww_opengis_netwps1_0_0_CTD_ANON_11_httpwww_opengis_netwps1_0_0Default', False)
    ...
    __Supported = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Supported'), 'Supported', '__httpwww_opengis_netwps1_0_0_CTD_ANON_11_httpwww_opengis_netwps1_0_0Supported', False)
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __AcceptVersions = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AcceptVersions'), 'AcceptVersions', '__httpwww_opengis_netwps1_0_0_CTD_ANON_12_httpwww_opengis_netwps1_0_0AcceptVersions', False)
    ...
    # Attribute service uses Python identifier service
    __service = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'service'), 'service', '__httpwww_opengis_netwps1_0_0_CTD_ANON_12_service', WPS_1_0_0._ows.ServiceType, fixed=True, unicode_default=u'WPS', required=True)
    ...
    __language = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'language'), 'language', '__httpwww_opengis_netwps1_0_0_CTD_ANON_12_language', pyxb.binding.datatypes.string)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Output = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Output'), 'Output', '__httpwww_opengis_netwps1_0_0_CTD_ANON_13_httpwww_opengis_netwps1_0_0Output', True)
...
class InputReferenceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute mimeType uses Python identifier mimeType
    __mimeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mimeType'), 'mimeType', '__httpwww_opengis_netwps1_0_0_InputReferenceType_mimeType', WPS_1_0_0._ows.MimeType)
    
    mimeType = property(__mimeType.value, __mimeType.set, None, u'The Format of this input or requested for this output (e.g., text/xml). This element shall be omitted when the Format is indicated in the http header of the output. When included, this format shall be one published for this output or input in the Process full description. ')

    
    # Attribute method uses Python identifier method
    __method = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__httpwww_opengis_netwps1_0_0_InputReferenceType_method', STD_ANON_2, unicode_default=u'GET')
...
class WPSCapabilitiesType (WPS_1_0_0._ows.CapabilitiesBaseType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'WPSCapabilitiesType')
    # Base type is WPS_1_0_0._ows.CapabilitiesBaseType
    ...
    _ElementMap = WPS_1_0_0._ows.CapabilitiesBaseType._ElementMap.copy()
    _ElementMap.update({
        __WSDL.name() : __WSDL,
        __ProcessOfferings.name() : __ProcessOfferings,
        __Languages.name() : __Languages
    })
    _AttributeMap = WPS_1_0_0._ows.CapabilitiesBaseType._AttributeMap.copy()
    _AttributeMap.update({
        __lang.name() : __lang,
        __service.name() : __service
    })
...
class RequestBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_opengis_netwps1_0_0_RequestBaseType_version', WPS_1_0_0._ows.VersionType, fixed=True, unicode_default=u'1.0.0', required=True)
...
class CTD_ANON_14 (RequestBaseType):
    ...
    __ResponseForm = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ResponseForm'), 'ResponseForm', '__httpwww_opengis_netwps1_0_0_CTD_ANON_14_httpwww_opengis_netwps1_0_0ResponseForm', False)
    ...
    __DataInputs = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DataInputs'), 'DataInputs', '__httpwww_opengis_netwps1_0_0_CTD_ANON_14_httpwww_opengis_netwps1_0_0DataInputs', False)
    ...
    # Element {http://www.opengis.net/ows/1.1}Identifier uses Python identifier Identifier
    __Identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), 'Identifier', '__httpwww_opengis_netwps1_0_0_CTD_ANON_14_httpwww_opengis_netows1_1Identifier', False)
...
class CTD_ANON_15 (RequestBaseType):
    ...
    # Element {http://www.opengis.net/ows/1.1}Identifier uses Python identifier Identifier
    __Identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), 'Identifier', '__httpwww_opengis_netwps1_0_0_CTD_ANON_15_httpwww_opengis_netows1_1Identifier', True)
...
class CTD_ANON_16 (ResponseBaseType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    __Status = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Status'), 'Status', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_httpwww_opengis_netwps1_0_0Status', False)
    ...
    # Element {http://www.opengis.net/wps/1.0.0}DataInputs uses Python identifier DataInputs
    __DataInputs = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DataInputs'), 'DataInputs', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_httpwww_opengis_netwps1_0_0DataInputs', False)
    ...
    # Element {http://www.opengis.net/wps/1.0.0}Process uses Python identifier Process
    __Process = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Process'), 'Process', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_httpwww_opengis_netwps1_0_0Process', False)
    ...
    __OutputDefinitions = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'OutputDefinitions'), 'OutputDefinitions', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_httpwww_opengis_netwps1_0_0OutputDefinitions', False)
    ...
    __ProcessOutputs = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProcessOutputs'), 'ProcessOutputs', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_httpwww_opengis_netwps1_0_0ProcessOutputs', False)
    ...
    __statusLocation = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'statusLocation'), 'statusLocation', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_statusLocation', pyxb.binding.datatypes.anyURI)
    ...
    __serviceInstance = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'serviceInstance'), 'serviceInstance', '__httpwww_opengis_netwps1_0_0_CTD_ANON_16_serviceInstance', pyxb.binding.datatypes.anyURI, required=True)
...
ProcessDescriptions = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProcessDescriptions'), CTD_ANON_1, documentation=u'WPS DescribeProcess operation response. ')
Namespace.addCategoryObject('elementBinding', ProcessDescriptions.name().localName(), ProcessDescriptions)

ProcessOfferings = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProcessOfferings'), CTD_ANON_6, documentation=u'List of brief descriptions of the processes offered by this WPS server. ')
Namespace.addCategoryObject('elementBinding', ProcessOfferings.name().localName(), ProcessOfferings)

WSDL = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WSDL'), CTD_ANON_3, documentation=u'Location of a WSDL document.')
Namespace.addCategoryObject('elementBinding', WSDL.name().localName(), WSDL)

Languages = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Languages'), CTD_ANON_11, documentation=u'Listing of the default and other languages supported by this service. ')
Namespace.addCategoryObject('elementBinding', Languages.name().localName(), Languages)

GetCapabilities = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GetCapabilities'), CTD_ANON_12)
...
ComplexDataDescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'MimeType'), WPS_1_0_0._ows.MimeType, scope=ComplexDataDescriptionType, documentation=u'Mime type supported for this input or output (e.g., text/xml). '))
...
ComplexDataDescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ComplexDataDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'MimeType'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ComplexDataDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Encoding'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ComplexDataDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'Schema'))),
    ])
...
ComplexDataCombinationsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ComplexDataCombinationsType._UseForTag(pyxb.namespace.ExpandedName(None, u'Format'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ComplexDataCombinationsType._UseForTag(pyxb.namespace.ExpandedName(None, u'Format'))),
    ])
...
OutputDefinitionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), WPS_1_0_0._ows.CodeType, scope=OutputDefinitionType, documentation=u'Unique identifier or name of this dataset. '))
OutputDefinitionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDefinitionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
DocumentOutputDefinitionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'), WPS_1_0_0._ows.LanguageStringType, scope=DocumentOutputDefinitionType, documentation=u'Brief narrative description of this resource, normally used for display to a human. '))

DocumentOutputDefinitionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'), WPS_1_0_0._ows.LanguageStringType, scope=DocumentOutputDefinitionType, documentation=u'Title of this resource, normally used for display to a human. '))
DocumentOutputDefinitionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DocumentOutputDefinitionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DocumentOutputDefinitionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=DocumentOutputDefinitionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=DocumentOutputDefinitionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
    ])
...
CRSsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CRSsType._UseForTag(pyxb.namespace.ExpandedName(None, u'CRS'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CRSsType._UseForTag(pyxb.namespace.ExpandedName(None, u'CRS'))),
    ])
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Output'), OutputDescriptionType, scope=CTD_ANON_4, documentation=u'Unordered list of one or more descriptions of all the outputs that can result from executing this process. At least one output is required from each process. '))
CTD_ANON_4._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(None, u'Output'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(None, u'Output'))),
    ])
...
ComplexDataCombinationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ComplexDataCombinationType._UseForTag(pyxb.namespace.ExpandedName(None, u'Format'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
SupportedCRSsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Default'), CTD_ANON_5, scope=SupportedCRSsType, documentation=u'Identifies the default CRS that will be used unless the Execute operation request specifies another supported CRS. '))
...
SupportedCRSsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SupportedCRSsType._UseForTag(pyxb.namespace.ExpandedName(None, u'Default'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SupportedCRSsType._UseForTag(pyxb.namespace.ExpandedName(None, u'Supported'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'CRS'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_5, documentation=u'Reference to the default CRS supported for this Input/Output'))
CTD_ANON_5._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(None, u'CRS'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Process'), ProcessBriefType, scope=CTD_ANON_6, documentation=u'Unordered list of one or more brief descriptions of all the processes offered by this WPS server. '))
CTD_ANON_6._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Process'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Process'))),
    ])
...
ComplexDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
...
DescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), WPS_1_0_0._ows.CodeType, scope=DescriptionType, documentation=u'Unique identifier or name of this dataset. '))

DescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'), WPS_1_0_0._ows.LanguageStringType, scope=DescriptionType, documentation=u'Brief narrative description of this resource, normally used for display to a human. '))

DescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'), WPS_1_0_0._ows.MetadataType, scope=DescriptionType))

DescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'), WPS_1_0_0._ows.LanguageStringType, scope=DescriptionType, documentation=u'Title of this resource, normally used for display to a human. '))
DescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
})
...
OutputDescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'BoundingBoxOutput'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'ComplexOutput'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=OutputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'LiteralOutput'))),
    ])
...
DataType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'BoundingBoxData'), WPS_1_0_0._ows.BoundingBoxType, scope=DataType, documentation=u'Identifies this input or output data as an ows:BoundingBox data structure, and provides that ows:BoundingBox data. '))
DataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ComplexData'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'LiteralData'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'BoundingBoxData'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
InputDescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'ComplexData'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'LiteralData'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'BoundingBoxData'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'ComplexData'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=InputDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'BoundingBoxData'))),
...
InputType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), WPS_1_0_0._ows.CodeType, scope=InputType, documentation=u'Unique identifier or name of this dataset. '))
...
InputType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'), WPS_1_0_0._ows.LanguageStringType, scope=InputType, documentation=u'Brief narrative description of this resource, normally used for display to a human. '))

InputType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'), WPS_1_0_0._ows.LanguageStringType, scope=InputType, documentation=u'Title of this resource, normally used for display to a human. '))
...
InputType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Data'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Data'))),
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Language'), pyxb.binding.datatypes.language, scope=CTD_ANON_8, documentation=u'Identifier of a language used by the data(set) contents. This language identifier shall be as specified in IETF RFC 4646. When this element is omitted, the language used is not identified. '))
CTD_ANON_8._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Language'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
LiteralOutputType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LiteralOutputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'DataType'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=LiteralOutputType._UseForTag(pyxb.namespace.ExpandedName(None, u'UOMs'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=LiteralOutputType._UseForTag(pyxb.namespace.ExpandedName(None, u'UOMs'))),
    ])
...
LiteralInputType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AllowedValues'), WPS_1_0_0._ows.CTD_ANON_7, scope=LiteralInputType, documentation=u'List of all the valid values and/or ranges of values for this quantity. For numeric quantities, signed values should be ordered from negative infinity to positive infinity. '))

LiteralInputType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AnyValue'), WPS_1_0_0._ows.CTD_ANON_2, scope=LiteralInputType, documentation=u'Specifies that any value is allowed for this parameter.'))
...
LiteralInputType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AllowedValues'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'DataType'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(None, u'ValuesReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(None, u'UOMs'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AnyValue'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AllowedValues'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AnyValue'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=LiteralInputType._UseForTag(pyxb.namespace.ExpandedName(None, u'DefaultValue'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
    ])
})
...
LanguagesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LanguagesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Language'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LanguagesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Language'))),
    ])
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Input'), InputDescriptionType, scope=CTD_ANON_10, documentation=u'Unordered list of one or more descriptions of the inputs that can be accepted by this process, including all required and optional inputs.  Where an input is optional because a default value exists, that default value must be identified in the "ows:Abstract" element for that input, except in the case of LiteralData, where the default must be indicated in the corresponding ows:DefaultValue element. Where an input is optional because it depends on the value(s) of other inputs, this must be indicated in the ows:Abstract element for that input. '))
CTD_ANON_10._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'Input'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(None, u'Input'))),
    ])
...
CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Default'), CTD_ANON_8, scope=CTD_ANON_11, documentation=u'Identifies the default language that will be used unless the operation request specifies another supported language. '))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Supported'), LanguagesType, scope=CTD_ANON_11, documentation=u'Unordered list of references to all of the languages supported by this service. The default language shall be included in this list.'))
CTD_ANON_11._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Default'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Supported'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AcceptVersions'), WPS_1_0_0._ows.AcceptVersionsType, scope=CTD_ANON_12, documentation=u'When omitted, server shall return latest supported version. '))
CTD_ANON_12._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AcceptVersions'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Output'), OutputDataType, scope=CTD_ANON_13, documentation=u'Unordered list of values of all the outputs produced by this process. It is not necessary to include an output until the Status is ProcessSucceeded. '))
CTD_ANON_13._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
    ])
...
InputReferenceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Header'), CTD_ANON_9, scope=InputReferenceType, documentation=u'Extra HTTP request headers needed by the service identified in ../Reference/@href.  For example, an HTTP SOAP request requires a SOAPAction header.  This permits the creation of a complete and valid POST request.'))
...
InputReferenceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'BodyReference'), CTD_ANON_7, scope=InputReferenceType, documentation=u'Reference to a remote document to be used as the body of the an HTTP POST request message to the service identified in ../Reference/@href.'))
InputReferenceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=InputReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Header'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Body'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InputReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'BodyReference'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
ProcessBriefType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WSDL'), CTD_ANON_3, scope=ProcessBriefType, documentation=u'Location of a WSDL document.'))
ProcessBriefType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'WSDL'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Profile'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Profile'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'WSDL'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ProcessBriefType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
...
ProcessDescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DataInputs'), CTD_ANON_10, scope=ProcessDescriptionType, documentation=u'List of the inputs to this process. In almost all cases, at least one process input is required. However, no process inputs may be identified when all the inputs are predetermined fixed resources.  In this case, those resources shall be identified in the ows:Abstract element that describes the process.'))

ProcessDescriptionType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ProcessOutputs'), CTD_ANON_4, scope=ProcessDescriptionType, documentation=u'List of outputs which will or can result from executing the process. '))
ProcessDescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'ProcessOutputs'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'DataInputs'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'ProcessOutputs'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Profile'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(None, u'DataInputs'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'WSDL'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=ProcessDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
    ])
...
WPSCapabilitiesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WSDL'), CTD_ANON_3, scope=WPSCapabilitiesType, documentation=u'Location of a WSDL document.'))

WPSCapabilitiesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProcessOfferings'), CTD_ANON_6, scope=WPSCapabilitiesType, documentation=u'List of brief descriptions of the processes offered by this WPS server. '))

WPSCapabilitiesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Languages'), CTD_ANON_11, scope=WPSCapabilitiesType, documentation=u'Listing of the default and other languages supported by this service. '))
WPSCapabilitiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ServiceProvider'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ServiceIdentification'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessOfferings'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'OperationsMetadata'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessOfferings'))),
    ])
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Languages'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=WPSCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'WSDL'))),
    ])
...
StatusType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=StatusType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessStarted'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=StatusType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessFailed'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=StatusType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessSucceeded'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=StatusType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessPaused'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=StatusType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessAccepted'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ResponseForm'), ResponseFormType, scope=CTD_ANON_14, documentation=u'Defines the response type of the WPS, either raw data or XML document.  If absent, the response shall be a response document which includes all outputs encoded in the response.'))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DataInputs'), DataInputsType, scope=CTD_ANON_14, documentation=u'List of input (or parameter) values provided to the process, including each of the Inputs needed to execute the process. It is possible to have no inputs provided only when all the inputs are predetermined fixed resources. In all other cases, at least one input is required. '))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), WPS_1_0_0._ows.CodeType, scope=CTD_ANON_14, documentation=u'Unique identifier or name of this dataset. '))
CTD_ANON_14._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ResponseForm'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DataInputs'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
...
SupportedComplexDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SupportedComplexDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Default'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SupportedComplexDataType._UseForTag(pyxb.namespace.ExpandedName(None, u'Supported'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
OutputDefinitionsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDefinitionsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDefinitionsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
    ])
...
SupportedComplexDataInputType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SupportedComplexDataInputType._UseForTag(pyxb.namespace.ExpandedName(None, u'Default'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SupportedComplexDataInputType._UseForTag(pyxb.namespace.ExpandedName(None, u'Supported'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
OutputDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Data'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Data'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=OutputDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
})
...
SupportedUOMsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Default'), CTD_ANON_2, scope=SupportedUOMsType, documentation=u'Reference to the default UOM supported for this input or output, if UoM is applicable. The process shall expect input in or produce output in this UOM unless the Execute request specifies another supported UOM. '))
...
SupportedUOMsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SupportedUOMsType._UseForTag(pyxb.namespace.ExpandedName(None, u'Default'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SupportedUOMsType._UseForTag(pyxb.namespace.ExpandedName(None, u'Supported'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
DataInputsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DataInputsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Input'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DataInputsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Input'))),
    ])
...
ResponseFormType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ResponseFormType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RawDataOutput'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ResponseFormType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ResponseDocument'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), WPS_1_0_0._ows.CodeType, scope=CTD_ANON_15, documentation=u'Unique identifier or name of this dataset. '))
CTD_ANON_15._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
...
UOMsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'UOM'), WPS_1_0_0._ows.DomainMetadataType, scope=UOMsType, documentation=u'Definition of the unit of measure of this set of values. In this case, the xlink:href attribute can reference a URN for a well-known unit of measure (uom). For example, such a URN could be a UOM identification URN defined in the "ogc" URN namespace. '))
UOMsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UOMsType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'UOM'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UOMsType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'UOM'))),
    ])
...
ProcessFailedType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ExceptionReport'), WPS_1_0_0._ows.CTD_ANON_4, scope=ProcessFailedType, documentation=u'Report message returned to the client that requested any OWS operation when the server detects an error while processing that operation request. '))
ProcessFailedType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ProcessFailedType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ExceptionReport'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
ResponseDocumentType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ResponseDocumentType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ResponseDocumentType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
    ])
...
CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Status'), StatusType, scope=CTD_ANON_16, documentation=u'Execution status of this process. '))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DataInputs'), DataInputsType, scope=CTD_ANON_16, documentation=u'Inputs that were provided as part of the execute request. This element shall be omitted unless the lineage attribute of the execute request is set to "true".'))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Process'), ProcessBriefType, scope=CTD_ANON_16, documentation=u'Process description from the ProcessOfferings section of the GetCapabilities response. '))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OutputDefinitions'), OutputDefinitionsType, scope=CTD_ANON_16, documentation=u'Complete list of Output data types that were requested as part of the Execute request. This element shall be omitted unless the lineage attribute of the execute request is set to "true".'))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProcessOutputs'), CTD_ANON_13, scope=CTD_ANON_16, documentation=u'List of values of the Process output parameters. Normally there would be at least one output when the process has completed successfully. If the process has not finished executing, the implementer can choose to include whatever final results are ready at the time the Execute response is provided. If the reference locations of outputs are known in advance, these URLs may be provided before they are populated. '))
CTD_ANON_16._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Process'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Status'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DataInputs'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessOutputs'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OutputDefinitions'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProcessOutputs'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OutputDefinitions'))),
