...
python GrassXMLtoZCFG.py -x ../Testing/Python/r.add.xml -z r_add.zcfg -p r_add.py
echo "r.sub.xml to r_sub.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.sub.xml -z r_sub.zcfg -p r_sub.py
echo "r.div.xml to r_div.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.div.xml -z r_div.zcfg -p r_div.py
echo "r.mult.xml to r_mult.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.mult.xml -z r_mult.zcfg -p r_mult.py
echo "r.watershed.xml to r_watershed.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.watershed.xml -z r_watershed.zcfg -p r_watershed.py
echo "r.univar.xml to r_univar.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.univar.xml -z r_univar.zcfg -p r_univar.py
echo "r.neighbors.xml to r_neighbors.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.neighbors.xml -z r_neighbors.zcfg -p r_neighbors.py
echo "r.contour.xml to r_contour.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/r.contour.xml -z r_contour.zcfg -p r_contour.py
echo "v.buffer.xml to v_buffer.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/v.buffer.xml -z v_buffer.zcfg -p v_buffer.py
echo "v.voronoi.xml to v_voronoi.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/v.voronoi.xml -z v_voronoi.zcfg -p v_voronoi.py
echo "v.to.rast.xml to v_to_rast.zcfg"
python GrassXMLtoZCFG.py -x ../Testing/Python/v.to.rast.xml -z v_to_rast.zcfg -p v_to_rast.py
